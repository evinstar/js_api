...
var document = {
  ...
  location: location,
  cookie: "__ac_nonce=062f0a431008b33c651dd; Path=/; Max-Age=1800",
  vlinkColor: "",
  referrer: "",
  fgColor: "",
  dir: "",
...
XMLHttpRequest.prototype.send = function() {
  ...
  ;qr = function(e, t, n) {
      return function() {
          ...
          if (!e)
              return hr;
          var i = e[t], a = n.apply(void 0, Wn([i], Vn(r))), s = a;
...
_f3("__ac_referer",document.referrer||"__ac_blank",!0);try{sessionStorage.setItem("__ac_ns",performance.timing.navigationStart)}catch(e){};
...
function get_ac_signature(__ac_nonce){
    return byted_acrawler.sign("",__ac_nonce);
}

local_module.exports = {
    get_ac_signature: get_ac_signature
}